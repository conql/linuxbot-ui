...
export default defineConfig({
  ...
  shortcuts: [{
    ...
    'gpt-password-input': 'px-4 py-3 h-12 rounded-lg bg-(slate op-15) base-focus',
    'gpt-password-submit': 'fcc h-12 w-12 bg-slate cursor-pointer bg-op-20 hover:bg-op-50',
    'gen-slate-btn': 'h-12 px-4 py-2 bg-(slate op-15) hover:bg-op-20 rounded-lg break-keep',
    'gen-cb-wrapper': 'h-12 my-4 fcc gap-4 bg-(slate op-15) rounded-lg',
    ...
    'gen-textarea': 'w-full px-3 py-3 min-h-12 max-h-36 rounded-lg bg-(slate op-15) resize-none base-focus placeholder:op-50 dark:(placeholder:op-30) scroll-pa-8px',
